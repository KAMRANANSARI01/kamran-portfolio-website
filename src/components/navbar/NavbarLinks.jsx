        ...
        return (
          <li key={index} className="group">
            <Link
              ...
              offset={-130}
              to={link.section}
              className="cursor-pointer text-white hover:text-[#8245ec] transition-all duration-500"
            >
              {link.link}
            </Link>
            <div className="mx-auto bg-[#8245ec] w-0 group-hover:w-full h-[1px] transition-all duration-500"></div>
          </li>
        );
      })}
    </ul>
